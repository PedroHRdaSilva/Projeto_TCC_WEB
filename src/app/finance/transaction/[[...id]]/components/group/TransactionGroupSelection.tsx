    ...
    >
      <form>
        <DialogTrigger asChild>
          <Button variant="outline" className="p-2.5 text-secondary-foreground">
            <ArrowRightLeftIcon size={18} />
          </Button>
        </DialogTrigger>
        <DialogContent className="sm:max-w-[800px]">
          <DialogHeader className="flex flex-row items-center justify-between w-full mt-4">
            ...
            {transactionsGroup?.map((group) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={"hidden items-center rounded-lg lg:flex border"}
                  >
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger
